...
class ETIDecoder {
    ...
    private:
        ...
        bool decode_deti(const std::vector<uint8_t>& value, const TagDispatcher::tag_name_t& n);
        bool decode_estn(const std::vector<uint8_t>& value, const TagDispatcher::tag_name_t& n);
